    ...
    <el-container>
      <el-aside width="auto">
        ...
        <el-menu
          ...
          @close="handleClose"
        >
          <el-menu-item index="/student-dashboard/personal-info">
            <el-icon><User /></el-icon>
            <template #title>个人信息</template>
          </el-menu-item>
          <el-menu-item index="/student-dashboard/view-grades">
            <el-icon><View /></el-icon>
            <template #title>查看成绩</template>
          </el-menu-item>
          <el-menu-item index="/student-dashboard/view-schedule">
            <el-icon><Grid /></el-icon>
            <template #title>查看课表</template>
          </el-menu-item>
          <el-menu-item index="/student-dashboard/submit-application">
